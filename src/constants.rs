...
pub const EZSP_MAX_HEADER_SIZE: usize = 5;
...
pub const EZSP_MAX_PARAMETER_SIZE: usize = 1028;

/// The largest frame size that can be sent or received by the `EZSP` protocol.
pub const EZSP_MAX_FRAME_SIZE: usize = EZSP_MAX_PARAMETER_SIZE + EZSP_MAX_HEADER_SIZE;
