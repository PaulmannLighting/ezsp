...
impl Parsable for super::Parameters {
        ...
        T: Iterator<Item = u8>,
    {
        ...
        match (id, disambiguation) {
            ...
            <binding::handler::RemoteDeleteBinding as Identified>::UNIQUE_ID => {
            ...
            <binding::handler::RemoteSetBinding as Identified>::UNIQUE_ID => {
            ...
            <bootloader::aes_encrypt::Response as Identified>::UNIQUE_ID => {
            ...
            <bootloader::get_standalone_bootloader_version_plat_micro_phy::Response as Identified>::UNIQUE_ID => {
            ...
            <bootloader::launch_standalone_bootloader::Response as Identified>::UNIQUE_ID => {
            ...
            <bootloader::override_current_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <bootloader::send_bootload_message::Response as Identified>::UNIQUE_ID => {
            ...
            <bootloader::handler::BootloadTransmitComplete as Identified>::UNIQUE_ID => {
            ...
            <bootloader::handler::IncomingBootloadMessage as Identified>::UNIQUE_ID => {
            ...
            <cbke::generate_cbke_keys283k1::Response as Identified>::UNIQUE_ID => {
            ...
            <cbke::save_preinstalled_cbke_data283k1::Response as Identified>::UNIQUE_ID => {
            ...
            <cbke::set_preinstalled_cbke_data::Response as Identified>::UNIQUE_ID => {
            ...
            <cbke::handler::CalculateSmacs as Identified>::UNIQUE_ID => {
            ...
            <cbke::handler::CalculateSmacs283k1 as Identified>::UNIQUE_ID => {
            ...
            <cbke::handler::GenerateCbkeKeys283k1 as Identified>::UNIQUE_ID => {
                Ok(Self::Callback(Callback::Cbke(cbke::handler::Handler::GenerateCbkeKeys283k1(
                    cbke::handler::GenerateCbkeKeys283k1::from_le_stream_exact(stream)?,
                ))))
            }
            // Configuration responses
            <configuration::add_endpoint::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::get_configuration_value::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::get_extended_value::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::get_policy::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::get_value::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::read_attribute::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::send_pan_id_update::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::set_configuration_value::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::set_passive_ack_config::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::set_policy::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::set_value::Response as Identified>::UNIQUE_ID => {
            ...
            <configuration::write_attribute::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::proxy_table::get_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::proxy_table::lookup::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::proxy_table::process_gp_pairing::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::clear_all::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::find_or_allocate_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::get_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::init::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::lookup::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::number_of_active_entries::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::remove_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::sink_table::set_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <green_power::handler::IncomingMessage as Identified>::UNIQUE_ID => {
            ...
            <green_power::handler::Sent as Identified>::UNIQUE_ID => {
            ...
            // Messaging responses
            <messaging::address_table_entry_is_active::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::get_address_table_remote_eui64::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::get_address_table_remote_node_id::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::get_beacon_classification_params::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::get_extended_timeout::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::get_multicast_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::lookup_eui64_by_node_id::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::lookup_node_id_by_eui64::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::maximum_payload_length::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::poll_for_data::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::proxy_broadcast::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::replace_address_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_broadcast::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_many_to_one_route_request::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_multicast::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_multicast_with_alias::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_raw_message::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_raw_message_extended::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_reply::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::send_unicast::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_address_table_remote_eui64::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_address_table_remote_node_id::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_beacon_classification_params::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_extended_timeout::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_mac_poll_failure_wait_time::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_multicast_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::set_source_route_discovery_mode::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::unicast_current_network_key::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::write_node_data::Response as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IdConflict as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingManyToOneRouteRequest as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingMessage as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingNetworkStatus as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingRouteError as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingRouteRecord as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::IncomingSenderEui64 as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::MacFilterMatchMessage as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::MacPassthroughMessage as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::MessageSent as Identified>::UNIQUE_ID => {
            ...
            <messaging::handler::RawTransmitComplete as Identified>::UNIQUE_ID => {
            ...
            <networking::energy_scan_request::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::find_and_rejoin_network::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::find_unused_pan_id::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::form_network::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_child_data::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_current_duty_cycle::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_duty_cycle_limits::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_duty_cycle_state::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_first_beacon::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_logical_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_neighbor::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_neighbor_frame_counter::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_network_parameters::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_next_beacon::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_num_stored_beacons::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_parent_child_parameters::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_radio_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_radio_parameters::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_route_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_routing_shortcut_threshold::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_source_route_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_source_route_table_filled_size::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::get_source_route_table_total_size::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::join_network_directly::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::leave_network::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::multi_phy_set_radio_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::multi_phy_set_radio_power::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::multi_phy_start::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::multi_phy_stop::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::neighbor_count::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::network_init::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::network_state::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::permit_joining::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::send_link_power_delta_request::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_broken_route_error_code::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_child_data::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_concentrator::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_duty_cycle_limits_in_stack::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_logical_and_radio_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_manufacturer_code::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_neighbor_frame_counter::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_power_descriptor::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_radio_channel::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_radio_ieee802154_cca_mode::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_radio_power::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::set_routing_shortcut_threshold::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::start_scan::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::stop_scan::Response as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::ChildJoin as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::DutyCycle as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::EnergyScanResult as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::NetworkFound as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::ScanComplete as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::StackStatus as Identified>::UNIQUE_ID => {
            ...
            <networking::handler::UnusedPanIdFound as Identified>::UNIQUE_ID => {
            ...
            // Security responses
            <security::check_key_context::Response as Identified>::UNIQUE_ID => {
            ...
            <security::clear_key_table::Response as Identified>::UNIQUE_ID => {
            ...
            <security::clear_transient_link_keys::Response as Identified>::UNIQUE_ID => {
            ...
            <security::erase_key_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <security::export_link_key_by_index::Response as Identified>::UNIQUE_ID => {
            ...
            <security::export_transient_key::by_eui::Response as Identified>::UNIQUE_ID => {
            ...
            <security::export_transient_key::by_index::Response as Identified>::UNIQUE_ID => {
            ...
            <security::find_key_table_entry::Response as Identified>::UNIQUE_ID => {
            ...
            <security::get_aps_key_info::Response as Identified>::UNIQUE_ID => {
            ...
            <security::get_current_security_state::Response as Identified>::UNIQUE_ID => {
            ...
            <security::import_transient_key::Response as Identified>::UNIQUE_ID => {
            ...
            <security::request_link_key::Response as Identified>::UNIQUE_ID => {
            ...
            <security::send_trust_center_link_key::Response as Identified>::UNIQUE_ID => {
            ...
            <security::set_initial_security_state::Response as Identified>::UNIQUE_ID => {
            ...
            <security::update_tc_link_key::Response as Identified>::UNIQUE_ID => {
            ...
            <security::handler::SwitchNetworkKey as Identified>::UNIQUE_ID => {
            ...
            <security::handler::ZigbeeKeyEstablishment as Identified>::UNIQUE_ID => {
            ...
            <token_interface::get_token_count::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::get_token_data::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::get_token_info::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::gp_security_test_vectors::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::reset_node::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::set_token_data::Response as Identified>::UNIQUE_ID => {
            ...
            <token_interface::token_factory_reset::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::aes_mmo_hash::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::broadcast_network_key_switch::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::broadcast_next_network_key::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::remove_device::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::unicast_nwk_key_update::Response as Identified>::UNIQUE_ID => {
            ...
            <trust_center::handler::TrustCenterJoin as Identified>::UNIQUE_ID => {
            ...
            // Utility responses
            <utilities::custom_frame::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::debug_write::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::delay_test::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::get_mfg_token::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::get_node_id::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::get_phy_interface_count::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::get_random_number::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::get_xncp_info::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::invalid_command::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::no_callbacks::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::nop::Response as Identified>::UNIQUE_ID => {
                Ok(Self::Response(Response::Utilities(utilities::Response::Nop(
                    utilities::nop::Response::from_le_stream_exact(stream)?,
                ))))
            }
            <utilities::read_and_clear_counters::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::read_counters::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::set_mfg_token::Response as Identified>::UNIQUE_ID => {
            ...
            <utilities::handler::CustomFrame as Identified>::UNIQUE_ID => {
            ...
            <utilities::handler::StackTokenChanged as Identified>::UNIQUE_ID => {
            ...
            <utilities::handler::Timer as Identified>::UNIQUE_ID => {
                Ok(Self::Callback(Callback::Utilities(utilities::handler::Handler::Timer(
                    utilities::handler::Timer::from_le_stream_exact(stream)?,
                ))))
            }
            // WWAH responses
            <wwah::get_parent_classification_enabled::Response as Identified>::UNIQUE_ID => {
            ...
            <wwah::set_long_uptime::Response as Identified>::UNIQUE_ID => {
                Ok(Self::Response(Response::Wwah(wwah::Response::SetLongUptime(
                    wwah::set_long_uptime::Response::from_le_stream_exact(stream)?,
                ))))
            }
            <wwah::set_parent_classification_enabled::Response as Identified>::UNIQUE_ID => {
            ...
            // ZLL responses
            <zll::clear_tokens::Response as Identified>::UNIQUE_ID => {
                Ok(Self::Response(Response::Zll(zll::Response::ClearTokens(
                    zll::clear_tokens::Response::from_le_stream_exact(stream)?,
                ))))
            }
            <zll::get_primary_channel_mask::Response as Identified>::UNIQUE_ID => {
            ...
            <zll::get_secondary_channel_mask::Response as Identified>::UNIQUE_ID => {
            ...
            <zll::rx_on_when_idle_get_active::Response as Identified>::UNIQUE_ID => {
            ...
            <zll::set_additional_state::Response as Identified>::UNIQUE_ID => {
            ...
            <zll::set_data_token::Response as Identified>::UNIQUE_ID => {
                Ok(Self::Response(Response::Zll(zll::Response::SetDataToken(
                    zll::set_data_token::Response::from_le_stream_exact(stream)?,
                ))))
            }
            <zll::set_initial_security_state::Response as Identified>::UNIQUE_ID => {
            ...
            <zll::set_security_state_without_key::Response as Identified>::UNIQUE_ID => {
