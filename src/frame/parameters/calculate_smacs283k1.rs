...
impl Command {
    #[must_use]
    pub const fn new(am_initiator: bool, partner_certificate: EmberCertificate283k1Data, partner_ephemeral_public_key: EmberPublicKey283k1Data) -> Self {
        Self { am_initiator, partner_certificate, partner_ephemeral_public_key }
    }
