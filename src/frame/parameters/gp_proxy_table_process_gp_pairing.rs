...
impl Command {
    #[must_use]
    pub const fn new(options: u32, addr: EmberGpAddress, comm_mode: u8, sink_network_address: u16, sink_group_id: u16, assigned_alias: u16, sink_ieee_address: uint8_t[8], gpd_key: EmberKeyData, gpd_security_frame_counter: u32, forwarding_radius: u8) -> Self {
    ...
    #[must_use]
    pub const fn sink_ieee_address(&self) -> uint8_t[8] {
