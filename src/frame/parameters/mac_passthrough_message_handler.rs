...
impl Response {
    #[must_use]
    pub const fn new(message_type: EmberMacPassthroughType, last_hop_lqi: u8, last_hop_rssi: int8s, message_length: u8, message_contents: ByteSizedVec<u8>) -> Self {
        Self { message_type, last_hop_lqi, last_hop_rssi, message_length, message_contents }
    }
