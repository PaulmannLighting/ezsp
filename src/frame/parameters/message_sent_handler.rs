...
use crate::types::{EmberOutgoingMessageType,EmberApsFrame,EmberStatus};
...
impl Response {
    #[must_use]
    pub const fn new(typ: EmberOutgoingMessageType, index_or_destination: u16, aps_frame: EmberApsFrame, message_tag: u8, status: EmberStatus, message_length: u8, message_contents: ByteSizedVec<u8>) -> Self {
        Self { typ, index_or_destination, aps_frame, message_tag, status, message_length, message_contents }
    }
