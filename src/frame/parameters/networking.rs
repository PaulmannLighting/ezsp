...
impl Command {
    ...
    pub const fn id(&self) -> u16 {
        match self {
            ...
            Self::SetChildData(_) => set_child_data::ID,
...
impl Writable for Command {
    ...
    {
        match self {
            Self::ChildId(child_id) => child_id.write_to(dst),
            ...
            Self::SetChildData(set_child_data) => set_child_data.write_to(dst),
