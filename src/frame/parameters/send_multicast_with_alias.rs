...
impl Command {
    #[must_use]
    pub const fn new(aps_frame: EmberApsFrame, hops: u8, nonmember_radius: u8, alias: u16, nwk_sequence: u8, message_tag: u8, message_length: u8, message_contents: ByteSizedVec<u8>) -> Self {
        Self { aps_frame, hops, nonmember_radius, alias, nwk_sequence, message_tag, message_length, message_contents }
    }
